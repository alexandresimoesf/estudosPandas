...
# 210	"leonardo Sales"
# 212	"leonardo Acioli de Queiroz "
# 211	"leonardo Chaves Azevedo e Silva"
import gerador
...
agenda_do_medico.to_csv('csv/leonardo_agenda_dermacapelli.csv', index=False)

########PRONTUARIO#########
prontuario_csv = read_csv('LEONARDO.csv', sep=';', encoding='latin-1', low_memory=False)
...
prontuarioPermissao_csv = read_csv('LEONARDO.csv', sep=';', encoding='latin-1', low_memory=False)
...
prontuarioPermissao_csv['fk_prontuario_id'] = prontuarioPermissao_csv['fk_medico_id'].apply(prontuario)
